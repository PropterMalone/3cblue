...
<h2>Quick Start</h2>
<ol>
  <li><strong>Follow <code>@3cblue.bsky.social</code></strong> — required to DM the bot (Bluesky platform requirement)</li>
  <li>Wait for a round announcement</li>
...
<h2>FAQ</h2>
<ul>
  <li><strong>Can I use any Magic card?</strong> — Yes, from any set, any era. The only bans are structural (un-sets, ante, subgames, wishes) plus winner bans from previous rounds. See the banned list below.</li>
  ...
  <li><strong>Why can't I DM the bot?</strong> — You need to follow <code>@3cblue.bsky.social</code> first. Bluesky requires a follow relationship to open DMs.</li>
</ul>

<h2>Banned Cards</h2>
<p>Structural bans (always banned):</p>
<ul>
  <li>Un-set cards (Unglued, Unhinged, Unstable, Unfinity acorn-stamped, etc.)</li>
  <li>Ante cards (<code>Contract from Below</code>, <code>Jeweled Bird</code>, etc.)</li>
  <li>Subgame cards (<code>Shahrazad</code>)</li>
  <li>Wishes and sideboard cards (<code>Burning Wish</code>, <code>Glittering Wish</code>, etc.)</li>
</ul>

<p>Winner bans (cards from winning decks of previous rounds):</p>
<div class="card" id="winner-bans">
  <em>None yet — first round hasn't started!</em>
</div>
